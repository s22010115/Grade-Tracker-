...
$sql = "UPDATE students SET name='$name', email='$email', phone='$phone' $password_query $photo_query WHERE student_id='$student_id'";
mysqli_query($conn, $sql);

header("Location: student-dashboard.php?msg=updated");
exit();
